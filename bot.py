...
def _summarize_with_gigachat(transcript: str) -> str:
    ...
    prompt = f"""
<role>
Ты — ассистент-аналитик с огромным опытом работы в сфере психологии
</role>
<task>
Дан транскрипт группового разговора из Discord.
- Кто какую позицию транслирует? Какие key-points?
- Кто все же прав в дискуссии?
- Какой итоговый вывод можно сделать? Какое послание донести?
</task>
Транскрипт:
{transcript}
"""
